...
This was actually a very effective method in organising the analysis. However, things things did not always run as smoothly. For example, the project may have been in the *deployment* stage when a small error would be noticed and there would be a need to go back to *data preparation* and *modeling* to make edits before outputting the results once again. Throughout this project, version control was used to document the project processes and a copy of the git log file can be found in the files of this project. 
